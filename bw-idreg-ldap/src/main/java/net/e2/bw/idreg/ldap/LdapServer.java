 ...
 * a BalticWeb-flavoured schema and test data is loaded.
 */
public class LdapServer extends AbstractLdapCommandLineTool {
    ...
    protected void loadLdifFromResource(DirectoryService service, String file) throws Exception {
        ...
        // NB: From command line: ldapadd -x -h 127.0.0.1:10389  -D "uid=admin,ou=system" -w secret -f balticweb-data.ldif
    }
    ...
    protected void execute() throws Exception {
        try {
            ...
            // Create a new partition named 'balticweb'.
            ...
            // Index some attributes on the balticweb partition
            addIndex(partition, "objectClass", "ou", "uid");

            // And start the service
            service.startup();

            // Inject the balticweb root entry if it does not already exist
            ...
            // Load the balticweb schema if it does not already exist
